...
class SehbAndTahtelDialog extends StatelessWidget {
  SehbAndTahtelDialog({super.key});
    ...
    return BlocProvider.value(
      ...
      child: BlocConsumer(
        ...
        builder: (context, state) {
          ...
          return CustomDialog(
            dialogHeight: MediaQuery.sizeOf(context).height * 0.42,
            child: Column(
            ...
            confirmTap: () => taskDDC.changeMissionState(),
          );
        },
      ),
    );
