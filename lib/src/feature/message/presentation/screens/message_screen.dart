        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              style: FontStyles.interSize20_700Primary.copyWith(color: AppColors.primary3),
            ),
          ),
          Assets.images.question.image(),
          Padding(
            padding: EdgeInsetsDirectional.symmetric(horizontal: MediaQuery.sizeOf(context).width * 0.15),
            child: ButtonWidget(
              borderRadius: 8.r,
